...
export default function About() {
    ...
    return(
        ...
        <div className="p-10 bg-zinc-100 h-auto">
            ...
            <h1 className="text-2xl lg:text-center font-medium text-orange-500 lg:text-3xl">REDE DE ENSINO <br />
                <span className="text-4xl lg:text-5xl font-extrabold">ALFATEC</span>
            </h1>
